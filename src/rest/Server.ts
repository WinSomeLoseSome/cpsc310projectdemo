    ...
    public start(): Promise<boolean> {
        ...
        return new Promise(function (fulfill, reject) {
            try {
                ...
                that.rest.get('/index.html',RouteHandler.getHomepage);
                that.rest.get('/schedule.html', RouteHandler.getSchedule);
                that.rest.get('/roomsQuery.html', RouteHandler.getRoomsQuery);
                that.rest.get('/uploadDataset.html', RouteHandler.getUploadDataset);
                that.rest.get('/coursesQuery.html', RouteHandler.getCoursesQuery);
                ...
                that.rest.post('/schedule', restify.bodyParser(), RouteHandler.scheduleQuery);

                that.rest.del('/dataset/:id', RouteHandler.delete); // should delete dataset
